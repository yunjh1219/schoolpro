...
public class AppointmentService {
    ...
    public void processAppointmentForm(AppointmentForm appointmentForm) {
        ...
        reservation.setReservation_date(appointmentForm.getReservation_date());
        reservation.setHour_select(appointmentForm.getHour_select());
        reservation.setMinutes_select(appointmentForm.getMinutes_select());
